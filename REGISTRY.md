...
## 现在在哪里（2026-09-15）
- v2 已上线：https://tianji-1gz.pages.dev （自定义域名 tianji.park-ai-intel.com 待 Park 添加 CNAME）。开放命语全部 23 种术数，命盘类出盘自动解读。
...
## 下一步
- Park：添加 CNAME `tianji → tianji-1gz.pages.dev`（Cloudflare 后台 park-ai-intel.com → DNS）。
