...
- v1 已上线：https://tianji.park-ai-intel.com （Cloudflare Pages 自定义域名；备用 https://tianji-1gz.pages.dev），内置 DeepSeek 解读已开启（Park 已填 `AI_API_KEY`）。
...
- 待定：手机端是否改为出盘后自动展开解读（目前要点"AI"按钮）。
